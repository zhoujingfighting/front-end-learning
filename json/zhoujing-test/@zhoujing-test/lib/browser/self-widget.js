...
var SelfWidget = /** @class */ (function (_super) {
    ...
    //
    SelfWidget.prototype.getWorkSpace = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.workspaceService.recentWorkspaces()];
            });
        });
    };
    SelfWidget.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("button", { onClick: function () {
                    ...
                    _this.getWorkSpace().then(function (res) { return console.log('eded', res); });
                } }, "\u70B9\u51FB\u6B64\u5904\u8DF3\u8F6C"),
    ...
    ], SelfWidget.prototype, "commandRegistry", void 0);
    __decorate([
        inversify_1.inject(browser_2.WorkspaceService),
        __metadata("design:type", browser_2.WorkspaceService)
    ], SelfWidget.prototype, "workspaceService", void 0);
    __decorate([
...
//这里是自定义widget
//# sourceMappingURL=self-widget.js.map