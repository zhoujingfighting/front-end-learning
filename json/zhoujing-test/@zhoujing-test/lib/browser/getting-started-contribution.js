...
exports.bindingGettingStarted = exports.GettingStartedContribution = exports.GettingStartedCommand = void 0;
...
var inversify_2 = require("@theia/core/shared/inversify");
var browser_3 = require("@theia/core/lib/browser");
exports.GettingStartedCommand = {
    id: getting_started_1.GettingStartedWidget.ID,
    label: getting_started_1.GettingStartedWidget.LABEL
};
var GettingStartedContribution = /** @class */ (function (_super) {
    ...
    function GettingStartedContribution() {
        var _this = _super.call(this, {
            widgetId: getting_started_1.GettingStartedWidget.ID,
            widgetName: getting_started_1.GettingStartedWidget.LABEL,
        ...
        _this.recentWorkSpace = [];
        return _this;
        // console.log('this',this)
    }
    GettingStartedContribution.prototype.init = function () {
    ...
    __decorate([
        inversify_1.inject(browser_3.OpenerService),
        __metadata("design:type", Object)
    ], GettingStartedContribution.prototype, "openerService", void 0);
    __decorate([
        inversify_2.postConstruct(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], GettingStartedContribution.prototype, "init", null);
...
var bindingGettingStarted = function (bind) {
    browser_1.bindViewContribution(bind, GettingStartedContribution);
    bind(browser_1.FrontendApplicationContribution).toService(GettingStartedContribution);
    bind(getting_started_1.GettingStartedWidget).toSelf();
