...
module.exports = Promise.resolve()
    ...
    .then(function () { return import('zhoujing-test/lib/browser/json-frontend-module').then(load) })
    .then(function () { return import('zhoujing-timeline/lib/browser/timeline-frontend-module').then(load) })
    .then(function () { return import('zhoujing-quickfile/lib/browser/theia-tranning-frontend-module').then(load) })
