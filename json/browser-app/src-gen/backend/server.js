...
module.exports = (port, host, argv) => Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('zhoujing-test/lib/node/json-backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('zhoujing-quickfile/lib/node/theia-traning-backend-module')).then(load) })
